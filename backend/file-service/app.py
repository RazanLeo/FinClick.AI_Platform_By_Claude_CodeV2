...
app.config['SQLALCHEMY_DATABASE_URI'] = os.getenv('DATABASE_URL', 'postgresql://user:password@localhost:5432/finclick_files')
...
app.config['GOOGLE_VISION_API_KEY'] = os.getenv('GOOGLE_VISION_API_KEY')
app.config['AWS_TEXTRACT_REGION'] = os.getenv('AWS_TEXTRACT_REGION', 'us-east-1')
...
def file_too_large(error):
    return jsonify({'error': 'File too large', 'message': 'File size exceeds maximum allowed'}), 413
