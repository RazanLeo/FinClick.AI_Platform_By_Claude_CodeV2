-- FinClick.AI Platform Database Initialization Script
-- This script creates the main database and user with proper permissions

-- Create database
CREATE DATABASE finclick_ai_main;

-- Create application user
CREATE USER finclick_app WITH PASSWORD 'FinClick2024SecurePassword!';

-- Grant necessary privileges
GRANT CONNECT ON DATABASE finclick_ai_main TO finclick_app;
GRANT USAGE ON SCHEMA public TO finclick_app;
GRANT CREATE ON SCHEMA public TO finclick_app;
